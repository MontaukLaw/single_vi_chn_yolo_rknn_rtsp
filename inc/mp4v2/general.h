...
#define MP4_IS_SYSTEMS_TRACK_TYPE(type) \
    (!strcasecmp(type, MP4_CLOCK_TRACK_TYPE) || !strcasecmp(type, MP4_MPEG7_TRACK_TYPE) || !strcasecmp(type, MP4_OCI_TRACK_TYPE) || !strcasecmp(type, MP4_IPMP_TRACK_TYPE) || !strcasecmp(type, MP4_MPEGJ_TRACK_TYPE))
...
#define MP4_IS_MPEG2_AAC_AUDIO_TYPE(type) \
    (((type) >= MP4_MPEG2_AAC_MAIN_AUDIO_TYPE && (type) <= MP4_MPEG2_AAC_SSR_AUDIO_TYPE))

#define MP4_IS_MPEG4_AAC_AUDIO_TYPE(mpeg4Type) \
    (((mpeg4Type) >= MP4_MPEG4_AAC_MAIN_AUDIO_TYPE && (mpeg4Type) <= MP4_MPEG4_AAC_HE_AUDIO_TYPE) || (mpeg4Type) == MP4_MPEG4_AAC_SCALABLE_AUDIO_TYPE || (mpeg4Type) == 17)

#define MP4_IS_AAC_AUDIO_TYPE(type) \
    (MP4_IS_MPEG2_AAC_AUDIO_TYPE(type) || (type) == MP4_MPEG4_AUDIO_TYPE)
...
#define MP4_IS_MPEG2_VIDEO_TYPE(type) \
    (((type) >= MP4_MPEG2_SIMPLE_VIDEO_TYPE && (type) <= MP4_MPEG2_442_VIDEO_TYPE) || MP4_IS_MPEG1_VIDEO_TYPE(type))
